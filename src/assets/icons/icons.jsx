const IconItem = ({ type, fillColor, strokeColor, width, height, classType, pathClass }) => {
	return (
		<>
			{type === "phone" ? (
				<svg width={width} height={height} fill={fillColor} viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" stroke="#000000">
			...
			{type === "check_circle" ? (
				<svg viewBox="0 0 24 24" width={width} height={height} fill={fillColor} xmlns="http://www.w3.org/2000/svg">
					...
					<g id="SVGRepo_iconCarrier">
						{" "}
						<circle cx="12" cy="12" r="10" stroke="#8ec73d" strokeWidth="1.5"></circle>
			...
			{type === "knowledge" ? (
				<svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" width={width} height={height} fill={fillColor} stroke={strokeColor} strokeWidth="3">
					...
					<g>
						<polygon stroke={strokeColor} points="32 36 8 24 32 12 56 24 32 36"></polygon>
						<polyline stroke={strokeColor} points="48 28 48 52 16 52 16 28"></polyline>
				...
				>
					...
					<g>
						<g>
							<polygon
								fill="#CCCCCC"
								points="41.44,28.714 19.618,28.714 9.113,28.714 3.219,14.787 19.237,14.787 41.142,14.787 57.25,14.787 52.458,28.714 "
							></polygon>
							<polygon
								fill="none"
								stroke={strokeColor}
								...
								strokeLinejoin="round"
								strokeMiterlimit="10"
								points=" 58.42,14.234 58.42,52.285 1.958,52.285 1.958,14.234 19.237,14.234 41.142,14.234 "
							></polygon>
							<polyline
								fill="none"
								stroke={strokeColor}
								...
								strokeLinejoin="round"
								strokeMiterlimit="10"
								points=" 41.142,14.234 41.142,6.4 19.237,6.4 19.237,14.234 "
							></polyline>
							<polyline
								fill="none"
								stroke={strokeColor}
								...
								strokeLinejoin="round"
								strokeMiterlimit="10"
								points=" 2.873,15.737 8.603,29.354 19.672,29.354 40.787,29.354 52.929,29.354 57.506,15.737 "
							></polyline>
							<path
								fill="none"
								stroke={strokeColor}
								...
								strokeLinejoin="round"
								strokeMiterlimit="10"
								d=" M19.339,27.285l-0.102,4.789L19.339,27.285z"
							></path>
							<path
								fill="none"
								stroke={strokeColor}
								...
								strokeLinejoin="round"
								strokeMiterlimit="10"
								d=" M41.193,27.285l-0.102,4.789L41.193,27.285z"
							></path>
							<path
								fill="none"
								stroke={strokeColor}
