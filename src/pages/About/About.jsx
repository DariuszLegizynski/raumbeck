				...
				{clickedItem === 2 ? (
					<section className="about__item-list">
						...
						<EducationItem
							addToRef={addToRefs}
							year="2011 – 2017"
							text="Physiotherapie Meusburger, Schwerpunkt: Triggerpunkttherapie"
						/>
						<EducationItem
							addToRef={addToRefs}
							year="2009 – 2017"
							text="Re.praxis für Physiotherapie, Schwerpunkt: Gynäkologie, Urologie & Proktologie"
						/>
					</section>
				) : null}
				{clickedItem === 3 ? (
					<section className="about__item-list">
						...
						<JobItem
							year="Jänner 2023"
							text="Viszerale Therapie – Läsionskette Verdauungstrakt – Wirbelsäule"
							addToRef={addToRefs}
						/>
						<JobItem
							year="November 2022"
							text="Beckenboden Special – Echtzeit Ultraschall in der Beckenbodentherapie beim Mann"
							addToRef={addToRefs}
						/>
						<JobItem
							year="Oktober 2020"
							text="Beckenboden Special – Das hintere Kompartiment"
							addToRef={addToRefs}
						/>
						<JobItem
							year="September 2020"
							text="Beckenboden Special – Vaginale Palpation Therapie"
							addToRef={addToRefs}
						/>
						<JobItem
							year="August 2020"
							text="Echtzeit-Ultraschallkurs in der Beckenbodentherapie"
							addToRef={addToRefs}
						/>
						<JobItem
							year="Dezember 2019"
							text="Geburt, Wochenbett, Evidenz"
							addToRef={addToRefs}
						/>
						<JobItem
							year="Juni 2019"
							text="SKENAR-Technologie – Basis-Seminar"
							addToRef={addToRefs}
						/>
						<JobItem
							year="April 2019"
							text="Physiotherapie bei Kindern mit anorektalen und urogenitalen Funktionsstörungen"
							addToRef={addToRefs}
						/>
						<JobItem
							year="Oktober 2017"
							text="Das Prostatakarzinom – Physiotherapeutische Behandlungsmöglichkeiten"
							addToRef={addToRefs}
						/>
						<JobItem
							year="Mai 2017"
						...
						<JobItem
							year="Januar 2017"
							text="Echtzeit-Ultraschall im Bereich Becken und Lendenwirbelsäule"
							addToRef={addToRefs}
						/>
						<JobItem
							year="April 2014"
							text="Physiotherapie bei anorektalen Dysfunktionen"
							addToRef={addToRefs}
						/>
						<JobItem
							year="November 2013"
							text="Grundlagen der Ernährung für eine optimierte physiotherapeutische Behandlung"
							addToRef={addToRefs}
						/>
						<JobItem
							year="September 2011"
							text="Nach der Geburt – Wochenbett und Rückbildung – Heller Konzept"
							addToRef={addToRefs}
						/>
						<JobItem
							year="März 2011"
							text="Beckenbodenrehabilitation beim Mann"
							addToRef={addToRefs}
						/>
						<JobItem
							year="November 2010"
							text="Beckenbodenfunktionen und -dysfunktionen, Physiotherapie nach dem Heller-Konzept"
							addToRef={addToRefs}
						/>
						<JobItem
							year="September 2010"
							text="Chronische Beckenboden und Unterleibsbeschwerden"
							addToRef={addToRefs}
						/>
						<JobItem
							year="Mai 2009"
							text="Weiterbildungen mit Schwerpunkt Triggerpunkttherapie"
							addToRef={addToRefs}
						/>
						<JobItem
							year="Oktober 2012"
							text="Manuelle Triggerpunkttherapie MTP3"
							addToRef={addToRefs}
						/>
						<JobItem
							year="November 2011"
							text="Manuelle Triggerpunkt-Therapie MTP2"
							addToRef={addToRefs}
						/>
						<JobItem
							year="Mai 2011"
							text="Manuelle Triggerpunkt-Therapie MTP1"
							addToRef={addToRefs}
						/>
						...
						<JobItem
							year="Februar 2010"
							text="Manuelle Therapie, Aufbaukurs Hals-Brustwirbelsäule-Arm-Bereich"
							addToRef={addToRefs}
						/>
						<JobItem
							year="Oktober 2009"
							text="Manuelle Therapie, Aufbaukurs Lenden-Becken-Bein-Bereich"
							addToRef={addToRefs}
						/>
						<JobItem
							year="März 2009"
							text="Manuelle Therapie, Weichteil-Kurs"
							addToRef={addToRefs}
						/>
						<JobItem
							year="November 2008"
							text="Manuelle Therapie, Wirbelsäulen Kurs"
							addToRef={addToRefs}
						/>
						<JobItem
							year="Juni 2008"
							text="Manuelle Therapie, Extremitäten Kurs"
							addToRef={addToRefs}
						/>
						<JobItem
							year="November 2008"
							text="Kinesiology, Power Spiral Taping"
							addToRef={addToRefs}
						/>
						<h3>Weiterbildungen mit Schwerpunkt Lymphdrainagetherapie</h3>
						<JobItem
							year="Oktober 2007"
							text="Manuelle Lymphdrainage nach Dr. Vodder"
							addToRef={addToRefs}
						/>
					</section>
				) : null}
